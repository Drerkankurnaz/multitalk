                    ...
                    <div class="lg:col-span-8 md:col-span-7">
                        ...
                        <div id="general" class="mt-6">
                            ...
                            <div id="accordion-collapsetwo" data-accordion="collapse" class="mt-6">
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden">
                                    <h2 class="font-medium" id="accordion-collapse-heading-5">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-6">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-7">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-8">
                        ...
                        <div id="payment" class="mt-6">
                            ...
                            <div id="accordion-collapsethree" data-accordion="collapse" class="mt-6">
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden">
                                    <h2 class="font-medium" id="accordion-collapse-heading-9">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-10">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-11">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-12">
                        ...
                        <div id="support" class="mt-6">
                            ...
                            <div id="accordion-collapsefour" data-accordion="collapse" class="mt-6">
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden">
                                    <h2 class="font-medium" id="accordion-collapse-heading-13">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-14">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-15">
                                ...
                                <div class="relative shadow dark:shadow-gray-700 rounded-md overflow-hidden mt-4">
                                    <h2 class="font-medium" id="accordion-collapse-heading-16">
