...
<div class="tagline bg-slate-100 dark:bg-slate-800">
            <div class="container relative">                
                <div class="grid grid-cols-1">
                    <div class="flex justify-center">
                        <span class="text-[16px]">Inform the best course offers with discounts up to 60%, <a href="" class="hover:text-violet-600 font-semibold">get it now</a> 🔥</span>
                    </div>
                </div>
            </div><!--end container-->
        </div><!--end tagline-->
        ...
        <nav id="topnav" class="defaultscroll is-sticky tagline-height">
            <div class="container relative">
                ...
                <div id="navigation">
                    <!-- Navigation Menu-->   
                    <ul class="navigation-menu justify-start nav-light">
