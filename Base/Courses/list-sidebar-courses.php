...
<div
    class="group bg-white dark:bg-slate-900 rounded-md shadow-md hover:shadow-lg shadow-slate-100 dark:shadow-slate-800 transition duration-500 w-full mx-auto">
    <div class="md:flex">
        <div class="p-3 md:pe-0 md:pb-3 pb-0 relative md:shrink-0">
            <img src="<?php echo $static_url, $item['img']; ?>" class="rounded-md size-full object-cover md:w-48"
                alt="">
        ...
        <div class="p-6 w-full">
            ...
            <div class="flex justify-between md:mt-12 mt-3">
                <span class="flex items-center"><img src="<?php echo $static_url, $item['img1']; ?>"
                        class="size-8 rounded-full shadow shadow-slate-100 dark:shadow-slate-800 me-2" alt=""> <a
                        href="" class="hover:text-violet-600 font-medium"> <?php echo $item['name']; ?></a></span>
                <a href=""
